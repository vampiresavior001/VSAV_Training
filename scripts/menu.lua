...
return {
    ...
    },
    {
      ...
      entries = {
        ...
        checkbox_menu_item("Show PB Counter", training_settings, "display_pb_counter",1, "How many push block presses the game counted in its window ($170), plus\nany after it grants - a lucky three would otherwise read three however\nhard you mash. Green once granted; the count carries across a blocked\nstring. Right: the TICK timeline of the last window (Guard opens,\nExpired closes, each digit = the buttons on that tick; 2+ red is a\nsimultaneous press). MultiPush counts those; the dummy shows as P2."),
