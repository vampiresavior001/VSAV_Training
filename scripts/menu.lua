...
return {
    ...
    },
    {
      ...
      entries = {
        ...
        checkbox_menu_item("Show PB Counter", training_settings, "display_pb_counter",1, "Push block presses the game counted ($170), plus any after it grants - a\nlucky three would read three however hard you mash. Green once granted; the\ncount carries a blocked string. Right: the TICK timeline of the last window\n(Guard opens it, | closes it, each digit = buttons that tick; 2+ red is\nsimultaneous). MultiPush counts those; the dummy shows as P2. LateMash:\nbuttons pressed AFTER those 14 ticks - past them nothing is bought. Cap 60t."),
